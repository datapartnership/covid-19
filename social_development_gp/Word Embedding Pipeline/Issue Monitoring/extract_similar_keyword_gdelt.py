"""
Module to extract word-level data used for policy issue viz based on GDELT Word2Vec
Developed by :
...
def main():
	...
	#Load Model
	model_all = gensim.models.Word2Vec.load('/mnt/louis/Issue Monitoring/model/w2v_gdelt_all_300.model')
	...
	df.to_csv('/mnt/louis/Issue Monitoring/gdelt_TOP_10_Similar_Issue_Keyword.csv',index=False)
	...
	df_topic_daily.to_csv('/mnt/louis/Issue Monitoring/gdelt_daily_keyword_count.csv',index=False)
	...
	df_keyword_evolution.to_csv('/mnt/louis/Issue Monitoring/gdelt_TOP_10_Evolution_Weekly_Similar_Issue_Keyword.csv',index=False)
	...
	df_topic_daily_new_normal.to_csv('/mnt/louis/Issue Monitoring/gdelt_daily_keyword_count_new_normal.csv',index=False)
