"""
Module to train Word2Vec in weekly format based on GDELT Data
Developed by :
...
def create_corpus(df):
	tweets_list = df['cleaned_text'].to_list()
...
def main():
    ...
    for week in unique_week_list:
        ...
        model.save('/mnt/louis/Issue Monitoring/model/w2v_gdelt_week_{}_300.model'.format(week))
